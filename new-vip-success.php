        ...
        <div class="row">
            <div class="container-tabs-login col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-4 text-center">
                ...
                <div class="row">
                    ...
                    <p class="text-success text-center">O usuário agora é VIP<br> Clique nos botões abaixo para prosseguir.</p>
                </div>
                <div class="row">
                    <a href="pre-vip-users.php" class="btn btn-success">Tornar outro usuário VIP</a>
