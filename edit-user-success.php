        ...
        <div class="row">
            <div class="container-tabs-login col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-4 text-center">
                ...
                <div class="row">
                    ...
                    <p class="text-success text-center">Seu perfil foi editado<br> Clique nos botões abaixo para prosseguir.</p>
                </div>
                <div class="row">
                    <a href="account.php?profile=<?php echo $list_info_session_user[id_user]; ?>" class="btn btn-success">Visualizar Perfil</a>
                    <a href="home.php" class="btn btn-default">Página Inicial</a>
                </div>
            </div>
        </div>  
    </div>
