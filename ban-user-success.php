        ...
        <div class="row">
            <div class="container-tabs-login col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-4 text-center">
                ...
                <div class="row">
                    ...
                    <p class="text-success text-center">O usuário foi banido<br> Clique nos botões abaixo para prosseguir.</p>
                </div>
                <div class="row">
                    <a href="all-users.php" class="btn btn-success">Banir outro usuário</a>
